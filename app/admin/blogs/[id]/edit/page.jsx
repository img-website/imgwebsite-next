...
export default function Page({ params }) {
    ...
    async function fetchOptions() {
      try {
        const [catRes, authRes] = await Promise.all([
          apiFetch('/api/v1/admin/blogs/categories?limit=100'),
          apiFetch('/api/v1/admin/blogs/authors?limit=100'),
        ]);
  ...
  useEffect(() => {
    ...
    // Always use string for _id (ObjectId) for dropdowns
    ...
    form.reset({
      category: getIdString(blog.category),
      authorId: getIdString(blog.author),
