...
export default function InstantDeliveryAppDevelopmentCompany() {
    ...
    useEffect(() => {
        if (!progressCircleRef.current || !processSwiperRef.current) return;

        const progressCircle = progressCircleRef.current;
        const strokeLength = progressCircle.getTotalLength();

        const swiper = processSwiperRef.current.swiper;
        const totalSlides = swiper.slides.length;
        const autoplayDelay = swiper.params.autoplay?.delay || 3000;
        let prevIndex = 0;
        let currentProgress = 0;

        const animateProgress = (fromPercent, toPercent, duration) => {
        const fromOffset = strokeLength - (strokeLength * fromPercent) / 100;
        const toOffset = strokeLength - (strokeLength * toPercent) / 100;
        const start = performance.now();

        function step(now) {
            const elapsed = now - start;
            const progress = Math.min(elapsed / duration, 1);
            const currentOffset = fromOffset + (toOffset - fromOffset) * progress;
        ...
        if (prevIndex === totalSlides - 1 && currentIndex === 0) {
            animateProgress(100, 0, 500);
            setTimeout(() => {
            animateProgress(0, 20, autoplayDelay);
            currentProgress = 20;
            }, 500);
        } else {
            const newProgress = ((currentIndex + 1) / totalSlides) * 100;
            animateProgress(currentProgress, newProgress, autoplayDelay);
    ...
    useEffect(() => {
        if (!processSwiperRef.current) return;
        const swiper = processSwiperRef.current.swiper;

        let isTicking = false;
        const btns = document.querySelectorAll('.processBtn');
        ...
        <>
            <section className="heroSection xl:pt-[116px] lg:pt-[90px] md:pt-[88px] pt-16 relative overflow-hidden md:min-h-dvh max-md:!h-auto flex flex-col max-md:pb-6 bg-gradient-to-b from-[#F4FFFE] to-[#F4F5F0]">
                <div className="!container flex flex-wrap relative z-10 grow justify-between max-sm:!px-0">
                    <div className="xl:w-6/12 lg:w-1/2 md:w-5/12 w-full flex flex-col max-sm:px-4">
                        ...
                        <div className="w-full 2xl:text-4xl xl:text-3xl lg:text-2xl text-xl md:font-bold font-semibold text-[#454444] text-balance relative max-md:text-center md:-ml-2"><span className="italic font-extrabold"><Image loading="lazy" width="19" height="60" src="https://d1y41eupgbwbb2.cloudfront.net/images/svg/instantI.svg" alt="Instant I" title="Instant I" className="w-auto xl:h-16 lg:h-10 h-9 xl:-mb-[13px] lg:-mb-2.5 -mb-2 xl:-mr-[5px] lg:-mr-1 -mr-0.5 inline aspect-[19/60]" />nstant Delivery</span> App <br /> &nbsp;Development Company</div>
                    ...
                    <div className="flex flex-col w-full">
                        <div className="flex flex-wrap justify-between items-center xl:py-16 lg:py-14 md:py-12 sm:py-10 py-8 gap-y-8">
                            <div className="md:w-6/12 w-full">
                                ...
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantEdition.webp" width="569" height="449" alt="From Zero to Zepto - Scale Up With 10 Minute Delivery App" title="From Zero to Zepto - Scale Up With 10 Minute Delivery App" className="md:w-10/12 object-contain object-center aspect-[569/449]" />
                            </div>
                                ...
                                <li className="w-full group/edition cursor-pointer">
                                    <div className="w-full bg-gradient-to-b from-[#742592] to-[#884B9F] shadow-[0px_4px_18.9px_0px_#0000001F] rounded-2xl flex flex-col p-0.5">
                                        <div className="flex flex-col items-center rounded-2xl md:p-6 p-4 md:gap-6 gap-4 bg-[#7D309A] group-hover/edition:lg:bg-white duration-500">
                                            ...
                                            <div className="flex flex-col gap-2 md:text-sm text-xs font-normal text-white group-hover/edition:lg:text-[#454444] duration-500">
                                                <p>Local businesses can pay to rank higher</p>
                                ...
                                <li className="w-full group/edition cursor-pointer">
                                    <div className="w-full bg-gradient-to-b from-[#742592] to-[#884B9F] shadow-[0px_4px_18.9px_0px_#0000001F] rounded-2xl flex flex-col p-0.5">
                                        <div className="flex flex-col items-center rounded-2xl md:p-6 p-4 md:gap-6 gap-4 bg-[#7D309A] group-hover/edition:lg:bg-white duration-500">
                                            ...
                                            <div className="flex flex-col gap-2 md:text-sm text-xs font-normal text-white group-hover/edition:lg:text-[#454444] duration-500">
                                                <p>Tier 2 & Tier 3 cities still have low competition.</p>
                    ...
                    <div className="flex flex-col w-full">
                        <div className="flex flex-wrap justify-between items-center xl:py-16 lg:py-14 md:py-12 sm:py-10 py-8 gap-y-8">
                            ...
                            <div className="xl:w-5/12 lg:w-5/12 md:w-6/12 w-full rounded-3xl flex items-center justify-center relative order-first max-md:max-w-80 max-md:mx-auto">
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantAppLike.webp" alt="Build Your Instant Delivery App Like Blinkit, Zepto & Instamart" title="Build Your Instant Delivery App Like Blinkit, Zepto & Instamart" className="w-full object-contain object-center" width="480" height="412" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex flex-col w-full xl:py-16 lg:py-14 md:py-12 sm:py-10 py-8">
                        <div className="flex flex-wrap justify-between">
                            ...
                            <div className="md:w-6/12 w-full rounded-3xl flex items-center justify-center relative max-md:order-first max-md:max-w-80 max-md:mx-auto">
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantCta3.webp" alt="We Deliver Personalized Experiences and Innovative Solutions." title="We Deliver Personalized Experiences and Innovative Solutions." className="size-full object-contain object-bottom" width="636" height="423" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="!container flex xl:py-16 lg:py-14 md:py-12 sm:py-10 py-8">
                    <div className="flex flex-col w-full">
                        ...
                        <Swiper className="w-full swiper rounded-3xl"
                            ...
                            >    
                                <SwiperSlide className="swiper-slide !flex flex-wrap justify-between items-stretch bg-[#2C2B30] rounded-3xl xl:p-12 md:p-8 py-6 px-4 gap-y-6">
                                    <div className="md:w-7/12 w-full">
                                        <div className="w-full flex items-center xl:gap-8 md:gap-4 gap-2">
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/dailyMartLogo.webp" className="w-auto md:h-14 h-12 aspect-square" width="56" height="56" alt="DailyMart Logo" title="DailyMart Logo" />
                                    ...
                                    <div className="md:w-4/12 w-full order-first rounded-3xl aspect-square flex items-center justify-center bg-gradient-to-br from-[#FF6F30] to-[#FEB25A] p-6">
                                        <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/dailyMart.webp" alt="DailyMart" title="DailyMart" className="size-full object-contain object-center aspect-[375/375]" width="375" height="375" />
                                    </div>
                                </SwiperSlide>
                                <SwiperSlide className="swiper-slide !flex flex-wrap justify-between items-stretch bg-[#2C2B30] rounded-3xl xl:p-12 md:p-8 py-6 px-4 gap-y-6">
                                    <div className="md:w-7/12 w-full">
                                        <div className="w-full flex items-center xl:gap-8 md:gap-4 gap-2">
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/qBasketLogo.webp" className="w-auto md:h-14 h-12 aspect-square" width="56" height="56" alt="QBasket Logo" title="QBasket Logo" />
                                    ...
                                    <div className="md:w-4/12 w-full order-first rounded-3xl aspect-square flex items-center justify-center bg-gradient-to-br from-[#FC7A42] to-[#FAA080] p-6">
                                        <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/qBasket.webp" alt="QBasket" title="QBasket" className="size-full object-contain object-center aspect-[375/375]" width="375" height="375" />
                                    </div>
                                </SwiperSlide>
                        ...
                        <div className="flex flex-wrap items-stretch gap-y-10 max-md:pt-10">
                            <div className="md:w-1/3 md:pt-32 pt-20 px-2.5 group/indus">
                                <div className="size-full flex flex-col bg-[#F2F2F2] ring-2 ring-inset group-hover/indus:lg:ring-[#FF6B39] max-md:ring-[#FF6B39] ring-white shadow-[0px_4px_29.5px_0px_#000000]/20 rounded-2xl py-4 md:px-8 px-4 relative group-hover/indus:lg:scale-95 duration-300">
                                    <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDarkStorkModelIcon.webp" alt="Dark Stork Model" title="Dark Stork Model" width="176" height="176" className="size-44 aspect-square object-contain object-center mx-auto -mt-32 group-hover/indus:lg:grayscale-0 md:grayscale duration-300" />
                            ...
                            <div className="md:w-1/3 md:pt-32 pt-20 px-2.5 group/indus">
                                <div className="size-full flex flex-col bg-[#F2F2F2] ring-2 ring-inset group-hover/indus:lg:ring-[#FF6B39] max-md:ring-[#FF6B39] ring-white shadow-[0px_4px_29.5px_0px_#000000]/20 rounded-2xl py-4 md:px-8 px-4 relative group-hover/indus:lg:scale-95 duration-300">
                                    <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantMarketplaceModelIcon.webp" alt="Marketplace Model" title="Marketplace Model" width="176" height="176" className="size-44 aspect-square object-contain object-center mx-auto -mt-32 group-hover/indus:lg:grayscale-0 md:grayscale duration-300" />
                            ...
                            <div className="md:w-1/3 md:pt-32 pt-20 px-2.5 group/indus">
                                <div className="size-full flex flex-col bg-[#F2F2F2] ring-2 ring-inset group-hover/indus:lg:ring-[#FF6B39] max-md:ring-[#FF6B39] ring-white shadow-[0px_4px_29.5px_0px_#000000]/20 rounded-2xl py-4 md:px-8 px-4 relative group-hover/indus:lg:scale-95 duration-300">
                                    <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantHybridModelIcon.webp" alt="Hybrid Model" title="Hybrid Model" width="176" height="176" className="size-44 aspect-square object-contain object-center mx-auto -mt-32 group-hover/indus:lg:grayscale-0 md:grayscale duration-300" />
                    ...
                    <div className="flex flex-col w-full">
                        ...
                        <div className="w-full items-start has-[#panel1:checked]:flex hidden">
                                ...
                                >
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="userPanel1" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryUserLogin.webp" alt="Social Media Login" title="Social Media Login" className="max-w-64 w-full mx-auto md:hidden aspect-[375/527]" width="375" height="527" />
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="userPanel2" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryUserTrackOrder.webp" alt="Order Tracking" title="Order Tracking" className="max-w-64 w-full mx-auto md:hidden aspect-[375/527]" width="375" height="527" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-white/50">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="userPanel3" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryUserSearch.webp" alt="Smart Search" title="Smart Search" className="max-w-64 w-full mx-auto md:hidden aspect-[375/527]" width="375" height="527" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-white/50">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="userPanel4" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryUserPayment.webp" alt="Multi-Payment Options" title="Multi-Payment Options" className="max-w-64 w-full mx-auto md:hidden aspect-[375/527]" width="375" height="527" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-white/50">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="userPanel5" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryOrderSchedule.webp" alt="Delivery Scheduling" title="Delivery Scheduling" className="max-w-64 w-full mx-auto md:hidden aspect-[375/527]" width="375" height="527" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-white/50">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="userPanel6" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryUserDiscount.webp" alt="Offers & Discounts" title="Offers & Discounts" className="max-w-64 w-full mx-auto md:hidden aspect-[375/527]" width="375" height="527" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-white/50">Swipe to show features</div>
                                            </div>
                            ...
                            <div className="xl:w-4/12 md:w-1/2 pl-20 md:!pt-12 !pt-7 !pb-6 md:sticky md:top-16 md:bottom-0 md:h-dvh max-md:hidden flex flex-col justify-center">
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryUserLogin.webp" alt="Social Media Login" title="Social Media Login" width="375" height="527" className="w-full mx-auto xl:max-w-96 max-w-64 aspect-[375/527] hidden group-has-[#userPanel1:checked]/key:md:block" />
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryUserTrackOrder.webp" alt="Order Tracking" title="Order Tracking" width="375" height="527" className="w-full mx-auto xl:max-w-96 max-w-64 aspect-[375/527] hidden group-has-[#userPanel2:checked]/key:md:block" />
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryUserSearch.webp" alt="Smart Search" title="Smart Search" width="375" height="527" className="w-full mx-auto xl:max-w-96 max-w-64 aspect-[375/527] hidden group-has-[#userPanel3:checked]/key:md:block" />
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryUserPayment.webp" alt="Multi-Payment Options" title="Multi-Payment Options" width="375" height="527" className="w-full mx-auto xl:max-w-96 max-w-64 aspect-[375/527] hidden group-has-[#userPanel4:checked]/key:md:block" />
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryOrderSchedule.webp" alt="Delivery Scheduling" title="Delivery Scheduling" width="375" height="527" className="w-full mx-auto xl:max-w-96 max-w-64 aspect-[375/527] hidden group-has-[#userPanel5:checked]/key:md:block" />
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryUserDiscount.webp" alt="Offers & Discounts" title="Offers & Discounts" width="375" height="527" className="w-full mx-auto xl:max-w-96 max-w-64 aspect-[375/527] hidden group-has-[#userPanel6:checked]/key:md:block" />
                            </div>
                        </div>
                        <div className="w-full items-start has-[#panel2:checked]:flex hidden">
                                ...
                                >
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="servicePanel1" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryVendorOrderManagement.webp" alt="Order Management" title="Order Management" className="max-w-64 w-full mx-auto md:hidden aspect-[375/527]" width="375" height="527" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-white/50">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="servicePanel2" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryVendorInventoryManagement.webp" alt="Inventory Management" title="Inventory Management" className="max-w-64 w-full mx-auto md:hidden aspect-[375/527]" width="375" height="527" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-white/50">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="servicePanel3" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryVendorPriceControl.webp" alt="Price Control" title="Price Control" className="max-w-64 w-full mx-auto md:hidden aspect-[375/527]" width="375" height="527" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-white/50">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="servicePanel4" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryVendorOrderAlert.webp" alt="Order Alerts" title="Order Alerts" className="max-w-64 w-full mx-auto md:hidden aspect-[375/527]" width="375" height="527" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-white/50">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="servicePanel5" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryVendorDeliveryManagement.webp" alt="Delivery Management" title="Delivery Management" className="max-w-64 w-full mx-auto md:hidden aspect-[375/527]" width="375" height="527" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-white/50">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="servicePanel6" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryVendorSales.webp" alt="Sales Analytics" title="Sales Analytics" className="max-w-64 w-full mx-auto md:hidden aspect-[375/527]" width="375" height="527" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-white/50">Swipe to show features</div>
                                            </div>
                            ...
                            <div className="xl:w-4/12 md:w-1/2 pl-20 md:!pt-12 !pt-7 !pb-6 md:sticky md:top-16 md:bottom-0 md:h-dvh max-md:hidden flex flex-col justify-center">
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryVendorOrderManagement.webp" alt="Order Management" title="Order Management" className="w-full mx-auto xl:max-w-96 max-w-64 hidden group-has-[#servicePanel1:checked]/key:md:block"  width="375" height="528" />
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryVendorInventoryManagement.webp" alt="Inventory Management" title="Inventory Management" className="w-full mx-auto xl:max-w-96 max-w-64 hidden group-has-[#servicePanel2:checked]/key:md:block"  width="375" height="528" />
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryVendorPriceControl.webp" alt="Price Control" title="Price Control" className="w-full mx-auto xl:max-w-96 max-w-64 hidden group-has-[#servicePanel3:checked]/key:md:block"  width="375" height="528" />
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryVendorOrderAlert.webp" alt="Order Alerts" title="Order Alerts" className="w-full mx-auto xl:max-w-96 max-w-64 hidden group-has-[#servicePanel4:checked]/key:md:block"  width="375" height="528" />
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryVendorDeliveryManagement.webp" alt="Delivery Management" title="Delivery Management" className="w-full mx-auto xl:max-w-96 max-w-64 hidden group-has-[#servicePanel5:checked]/key:md:block"  width="375" height="528" />
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryVendorSales.webp" alt="Sales Analytics" title="Sales Analytics" className="w-full mx-auto xl:max-w-96 max-w-64 hidden group-has-[#servicePanel6:checked]/key:md:block"  width="375" height="528" />
                            </div>
                        </div>
                        <div className="w-full items-start has-[#panel3:checked]:flex hidden">
                                ...
                                >
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="restaurant1" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryDriverRegistration.webp" alt="Registration" title="Registration" className="max-w-64 w-full mx-auto md:hidden aspect-[256/179]"  width="375" height="528" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-white/50">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="restaurant2" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryDriverOrderVerification.webp" alt="Order Verification" title="Order Verification" className="max-w-64 w-full mx-auto md:hidden aspect-[256/179]"  width="375" height="528" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-white/50">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="restaurant3" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryDriverRoute.webp" alt="Route Optimization" title="Route Optimization" className="max-w-64 w-full mx-auto md:hidden aspect-[256/179]"  width="375" height="528" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-white/50">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="restaurant4" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryDriverOrderAlert.webp" alt="Instant Order Alerts" title="Instant Order Alerts" className="max-w-64 w-full mx-auto md:hidden aspect-[256/179]"  width="375" height="528" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-white/50">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="restaurant5" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryDriverEarning.webp" alt="Earnings" title="Earnings" className="max-w-64 w-full mx-auto md:hidden aspect-[256/179]"  width="375" height="528" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-white/50">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="restaurant6" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryDriverChat.webp" alt="In-App Chat" title="In-App Chat" className="max-w-64 w-full mx-auto md:hidden aspect-[256/179]"  width="375" height="528" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-white/50">Swipe to show features</div>
                                            </div>
                            ...
                            <div className="xl:w-4/12 md:w-1/2 pl-20 md:!pt-12 !pt-7 !pb-6 md:sticky md:top-16 md:bottom-0 md:h-dvh max-md:hidden flex flex-col justify-center">
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryDriverRegistration.webp" alt="Dashboard" title="Dashboard" className="w-full mx-auto xl:max-w-96 max-w-64 hidden group-has-[#restaurant1:checked]/key:md:block"  width="375" height="528" />
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryDriverOrderVerification.webp" alt="Personalized Offers" title="Personalized Offers" className="w-full mx-auto xl:max-w-96 max-w-64 hidden group-has-[#restaurant2:checked]/key:md:block"  width="375" height="528" />
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryDriverRoute.webp" alt="AI-Powered Forecast" title="AI-Powered Forecast" className="w-full mx-auto xl:max-w-96 max-w-64 hidden group-has-[#restaurant3:checked]/key:md:block"  width="375" height="528" />
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryDriverOrderAlert.webp" alt="User Management" title="User Management" className="w-full mx-auto xl:max-w-96 max-w-64 hidden group-has-[#restaurant4:checked]/key:md:block"  width="375" height="528" />
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryDriverEarning.webp" alt="Zone Management" title="Zone Management" className="w-full mx-auto xl:max-w-96 max-w-64 hidden group-has-[#restaurant5:checked]/key:md:block"  width="375" height="528" />
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryDriverChat.webp" alt="Payment Management" title="Payment Management" className="w-full mx-auto xl:max-w-96 max-w-64 hidden group-has-[#restaurant6:checked]/key:md:block"  width="375" height="528" />
                            </div>
                        </div>
                        <div className="w-full items-start has-[#panel4:checked]:flex hidden">
                                ...
                                >
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="adminPanel1" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryAdmin.webp" alt="Dashboard" title="Dashboard" className="max-w-64 w-full mx-auto md:hidden aspect-[256/179]" width="1338" height="936" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-white/50">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="adminPanel2" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryAdmin.webp" alt="Personalized Offers" title="Personalized Offers" className="max-w-64 w-full mx-auto md:hidden aspect-[256/179]" width="1338" height="936" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-white/50">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="adminPanel3" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryAdmin.webp" alt="AI-Powered Forecast" title="AI-Powered Forecast" className="max-w-64 w-full mx-auto md:hidden aspect-[256/179]" width="1338" height="936" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-white/50">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="adminPanel4" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryAdmin.webp" alt="User Management" title="User Management" className="max-w-64 w-full mx-auto md:hidden aspect-[256/179]" width="1338" height="936" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-white/50">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="adminPanel5" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryAdmin.webp" alt="Zone Management" title="Zone Management" className="max-w-64 w-full mx-auto md:hidden aspect-[256/179]" width="1338" height="936" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-white/50">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="adminPanel6" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryAdmin.webp" alt="Payment Management" title="Payment Management" className="max-w-64 w-full mx-auto md:hidden aspect-[256/179]" width="1338" height="936" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-white/50">Swipe to show features</div>
                                            </div>
                            ...
                            <div className="xl:w-4/12 md:w-1/2 pl-20 md:!pt-12 !pt-7 !pb-6 md:sticky md:top-16 md:bottom-0 md:h-dvh max-md:hidden flex flex-col justify-center">
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantDeliveryAdmin.webp" alt="admin" title="admin" width="375" height="262" className="w-full mx-auto xl:max-w-96 max-w-64 max-md:hidden aspect-[375/262]" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="cta2Section w-full relative overflow-hidden bg-[#f7f8fa]">
                ...
                <div className="md:w-6/12 w-full rounded-3xl flex items-center justify-center md:absolute md:inset-y-0 md:right-0">
                    <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantCta1.webp" width="763" height="475" alt="Ready to Build the Future of Instant Commerce?" title="Ready to Build the Future of Instant Commerce?" className="size-full object-contain object-right-bottom aspect-[763/475]" />
                </div>
            </section>
                        ...
                        <div className="flex flex-wrap justify-between relative items-end">
                            ...
                            <div className="xl:w-3/12 lg:w-4/12 w-full lg:bottom-0 lg:sticky">
                                <div className="w-full md:pt-8 max-md:px-8">
                                    <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantNextGen.webp" width="341" height="562" alt="Smart Q Commerce App Solutions With Smart Features" title="Smart Q Commerce App Solutions With Smart Features" className="w-full aspect-[341/562]" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col w-full">
                        ...
                        <div className="flex flex-wrap lg:pt-20 md:pt-10 pt-8 items-center md:justify-between justify-center group/process">
                            <div className="md:w-6/12 sm:w-10/12 w-full">
                                <Swiper className="flex w-full swiper processSwiper pointer-events-none *:!flex *:!items-stretch"
                                    slidesPerView={1}
                                    spaceBetween={32}
                                    speed={1000}
                                    loop={true}
                                    ...
                                    modules={[Autoplay]}
                                    ref={processSwiperRef}
                                    >
                                        <SwiperSlide className="swiper-slide w-full slide1 [&.swiper-slide-active]:*:!opacity-100 *:!opacity-0 [&.swiper-slide-active]:*:!delay-500 *:!delay-100 [&.swiper-slide-active]:*:!scale-100 *:!scale-50 *:origin-left *:!duration-300">
                                        ...
                                        <SwiperSlide className="swiper-slide w-full slide2 [&.swiper-slide-active]:*:!opacity-100 *:!opacity-0 [&.swiper-slide-active]:*:!delay-500 *:!delay-100 [&.swiper-slide-active]:*:!scale-100 *:!scale-50 *:origin-left *:!duration-300">
                                            <h3 className="w-full 2xl:text-3xl xl:text-2xl lg:text-xl text-lg font-semibold text-white md:pb-6 pb-4">
                                                <span className="size-9 shrink-0 rounded-full bg-white inline-flex justify-center items-center mr-4">
                                        ...
                                        <SwiperSlide className="swiper-slide w-full slide3 [&.swiper-slide-active]:*:!opacity-100 *:!opacity-0 [&.swiper-slide-active]:*:!delay-500 *:!delay-100 [&.swiper-slide-active]:*:!scale-100 *:!scale-50 *:origin-left *:!duration-300">
                                            <h3 className="w-full 2xl:text-3xl xl:text-2xl lg:text-xl text-lg font-semibold text-white md:pb-6 pb-4">
                                                <span className="size-9 shrink-0 rounded-full bg-white inline-flex justify-center items-center mr-4">
                                        ...
                                        <SwiperSlide className="swiper-slide w-full slide4 [&.swiper-slide-active]:*:!opacity-100 *:!opacity-0 [&.swiper-slide-active]:*:!delay-500 *:!delay-100 [&.swiper-slide-active]:*:!scale-100 *:!scale-50 *:origin-left *:!duration-300">
                                            <h3 className="w-full 2xl:text-3xl xl:text-2xl lg:text-xl text-lg font-semibold text-white md:pb-6 pb-4">
                                                <span className="size-9 shrink-0 rounded-full bg-white inline-flex justify-center items-center mr-4">
                                        ...
                                        <SwiperSlide className="swiper-slide w-full slide5 [&.swiper-slide-active]:*:!opacity-100 *:!opacity-0 [&.swiper-slide-active]:*:!delay-500 *:!delay-100 [&.swiper-slide-active]:*:!scale-100 *:!scale-50 *:origin-left *:!duration-300">
                                            <h3 className="w-full 2xl:text-3xl xl:text-2xl lg:text-xl text-lg font-semibold text-white md:pb-6 pb-4">
                                                <span className="size-9 shrink-0 rounded-full bg-white inline-flex justify-center items-center mr-4">
                            ...
                            <div className="lg:w-5/12 md:w-6/12 w-auto max-md:order-first">
                                <div className="relative size-96 lg:scale-100 md:scale-75 sm:scale-90 scale-[0.60] md:origin-center origin-top max-sm:-mb-28">
                                    <svg className="size-full" viewBox="0 0 200 200">
                                        <circle cx="100" cy="100" r="1" fill="none" stroke="#9541B6" strokeWidth="130" />
                                        <circle cx="100" cy="100" r="1" fill="none" stroke="#ffffff" strokeWidth="90" />
                                        <circle cx="100" cy="100" r="95" fill="none" stroke="#AB66C7" strokeWidth="5" />
                                        <circle
                                    ...
                                    <div className="processBtn absolute cursor-pointer size-full shrink-0 rounded-full bg-[#BE89D4] group-has-[.slide1.swiper-slide-active]/process:bg-[#FF6B39] flex items-center justify-center lg:text-2xl md:text-xl sm:text-lg text-base font-bold text-[#7B239E] group-has-[.slide1.swiper-slide-active]/process:text-white ring-0 hover:lg:ring-8 group-has-[.slide1.swiper-slide-active]/process:ring-8 ring-[#7B239E] duration-300 -top-[150px] -right-[100px]" data-slide="0">
                                        <svg className="transform -rotate-90 size-full scale-105 absolute inset-0 [&_.bgCircle]:hidden [&_.valueCircle]:stroke-white duration-500 opacity-0 group-has-[.slide1.swiper-slide-active]/process:opacity-100 delay-300 group-has-[.slide1.swiper-slide-active]/process:[&_.valueCircle]:animate-progress-circle" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                                            <circle className="valueCircle" cx="50%" cy="50%" r="40%" stroke="orange" strokeWidth="3" fill="none" strokeLinecap="round" strokeDasharray="251.2" strokeDashoffset="calc(251.2 - (251.2 * 0 / 100)" />
                                        </svg>
                                        <span>01</span>
                                    </div>
                                ...
                                <div className="w-full md:pt-6 pt-4 max-md:text-center">
                                    <label htmlFor="leadPopup" className="cursor-pointer xl:text-base sm:text-sm text-xs md:font-semibold font-medium text-black inline-flex items-center xl:py-3 sm:py-2.5 py-2 xl:ps-6 sm:ps-4 ps-3 xl:pe-3 sm:pe-2.5 pe-1.5 xl:gap-3 gap-2 rounded-full bg-gradient-to-b from-[#FFFFFF] to-[#EDEBEB] duration-500 hover:lg:ring-4 hover:lg:ring-inset hover:lg:ring-[#EDEBEB] group/btn">
                                        ...
                                        <div className="inline-flex items-center justify-center shrink-0 xl:size-7 size-6 rounded-full bg-white group-hover/btn:lg:scale-110 relative group-hover/btn:lg:bg-[#FFFFFF] before:absolute before:inset-0 before:rounded-full before:bg-white before:duration-300 before:scale-0 group-hover/btn:lg:before:scale-100 duration-300">
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/fireIcon.webp" alt="Let's Make It Happen!" className="size-6 relative z-10 [&_path]:fill-[#EDEBEB]" width="60" height="60" />
                                        </div>
                                    </label>
                                </div>
                            </div>
                        ...
                        <Swiper className="swiper flex xl:w-7/12 lg:w-3/4 w-full -mt-6 xl:!py-16 lg:!py-14 !py-12 before:absolute before:left-0 before:h-full before:w-1/4 before:bg-gradient-to-r before:from-[#131514]/60 before:to-transparent before:z-10 before:pointer-events-none after:absolute after:right-0 after:h-full after:w-1/4 after:bg-gradient-to-l after:from-[#131514]/60 after:to-transparent after:z-10 after:pointer-events-none"
                            ...
                            >
                                <SwiperSlide className="swiper-slide relative lg:p-[1.2%] md:p-[2.2%] p-[2.7%] group [&.swiper-slide-active]:!scale-100 md:!scale-95 !scale-90 duration-300">
                                    ...
                                    <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantLookLike1.webp" alt="Dating App Look like" title="Dating App Look like" className="size-full object-contain object-center"  width="225" height="501" />
                                </SwiperSlide>
                                <SwiperSlide className="swiper-slide relative lg:p-[1.2%] md:p-[2.2%] p-[2.7%] group [&.swiper-slide-active]:!scale-100 md:!scale-95 !scale-90 duration-300">
                                    <Svg name="blackMobileFrame" className="size-full object-contain object-center absolute inset-0 text-[#404040] opacity-0 group-[&.swiper-slide-active]:opacity-100 scale-125 group-[&.swiper-slide-active]:scale-100 duration-300" />
                                    <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantLookLike2.webp" alt="Dating App Look like" title="Dating App Look like" className="size-full object-contain object-center"  width="225" height="501" />
                                </SwiperSlide>
                                <SwiperSlide className="swiper-slide relative lg:p-[1.2%] md:p-[2.2%] p-[2.7%] group [&.swiper-slide-active]:!scale-100 md:!scale-95 !scale-90 duration-300">
                                    <Svg name="blackMobileFrame" className="size-full object-contain object-center absolute inset-0 text-[#404040] opacity-0 group-[&.swiper-slide-active]:opacity-100 scale-125 group-[&.swiper-slide-active]:scale-100 duration-300" />
                                    <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantLookLike3.webp" alt="Dating App Look like" title="Dating App Look like" className="size-full object-contain object-center"  width="225" height="501" />
                                </SwiperSlide>
                                <SwiperSlide className="swiper-slide relative lg:p-[1.2%] md:p-[2.2%] p-[2.7%] group [&.swiper-slide-active]:!scale-100 md:!scale-95 !scale-90 duration-300">
                                    <Svg name="blackMobileFrame" className="size-full object-contain object-center absolute inset-0 text-[#404040] opacity-0 group-[&.swiper-slide-active]:opacity-100 scale-125 group-[&.swiper-slide-active]:scale-100 duration-300" />
                                    <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantLookLike4.webp" alt="Dating App Look like" title="Dating App Look like" className="size-full object-contain object-center"  width="225" height="501" />
                                </SwiperSlide>
                                <SwiperSlide className="swiper-slide relative lg:p-[1.2%] md:p-[2.2%] p-[2.7%] group [&.swiper-slide-active]:!scale-100 md:!scale-95 !scale-90 duration-300">
                                    <Svg name="blackMobileFrame" className="size-full object-contain object-center absolute inset-0 text-[#404040] opacity-0 group-[&.swiper-slide-active]:opacity-100 scale-125 group-[&.swiper-slide-active]:scale-100 duration-300" />
                                    <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantLookLike5.webp" alt="Dating App Look like" title="Dating App Look like" className="size-full object-contain object-center"  width="225" height="501" />
                                </SwiperSlide>
                                <SwiperSlide className="swiper-slide relative lg:p-[1.2%] md:p-[2.2%] p-[2.7%] group [&.swiper-slide-active]:!scale-100 md:!scale-95 !scale-90 duration-300">
                                    <Svg name="blackMobileFrame" className="size-full object-contain object-center absolute inset-0 text-[#404040] opacity-0 group-[&.swiper-slide-active]:opacity-100 scale-125 group-[&.swiper-slide-active]:scale-100 duration-300" />
                                    <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/instantLookLike6.webp" alt="Dating App Look like" title="Dating App Look like" className="size-full object-contain object-center"  width="225" height="501" />
                                </SwiperSlide>
                        </Swiper>
                    </div>
                </div>
