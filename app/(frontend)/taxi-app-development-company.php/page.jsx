        ...
        <>
            <section className="heroSection xl:pt-[116px] lg:pt-[90px] md:pt-[88px] pt-16 relative overflow-hidden md:min-h-dvh max-md:!h-auto flex flex-col max-md:pb-6 bg-[#F4FFFE]">
                <div className="!container flex flex-wrap relative z-10 grow justify-between max-sm:!px-0">
                    <div className="xl:w-6/12 lg:w-1/2 md:w-5/12 w-full flex flex-col max-sm:px-4">
                        ...
                        <ul className="flex flex-wrap gap-4 max-md:justify-center">
                            <li className="inline-flex md:gap-2 gap-1 items-center md:py-2 py-1 md:ps-2 ps-1 md:pe-4 pe-2 text-[#454444] md:text-xs text-[10px] font-normal rounded-full bg-gradient-to-r from-[#FFFFFF] to-[#F4FFFE] shadow-[-2px_1px_4px_0px_#00000040]">
                                <Svg name="check" className="size-5 text-[#FF6B39]" />
                    ...
                    <div className="xl:w-6/12 lg:w-1/2 md:w-7/12 w-full flex flex-col relative max-md:order-first">
                        <Image priority={true} src="https://d1y41eupgbwbb2.cloudfront.net/images/TaxiHeroImage.webp" width="683" height="566" alt="Experience the power of Top Taxi Booking App Development Company" title="Experience the power of Top Taxi Booking App Development Company" className="md:absolute md:top-0 md:inset-x-0 md:bottom-0 md:size-full w-full object-cover md:object-left-bottom object-center max-md:hidden aspect-[683/614]" />
                        <Image priority={true} src="https://d1y41eupgbwbb2.cloudfront.net/images/TaxiHeroMobileImage.webp" width="815" height="579" alt="Experience the power of Top Taxi Booking App Development Company" title="Experience the power of Top Taxi Booking App Development Company" className="md:absolute md:top-0 md:inset-x-0 md:bottom-0 md:size-full w-full object-cover md:object-left-bottom object-center md:hidden aspect-[16/13]" />
                    </div>
                </div>
            </section>
                            ...
                            <div className="grid xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3 grid-cols-2 gap-5 justify-center">
                                <div className="rounded-md grid items-center md:hover:scale-95 duration-300 justify-center p-2 ring-1 ring-black/10">
                                    <Image
                                        ...
                                        width="79"
                                        height="89"
                                        loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/logos/adani.webp"
                                        alt="adani"
                                        title="adani"
                                        />
                                </div>
                                <div className="rounded-md grid items-center md:hover:scale-95 duration-300 justify-center p-2 ring-1 ring-black/10">
                                    <Image
                                        ...
                                        loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/logos/coachingselect.webp"
                                        alt="coachingselect"
                                ...
                                <div className="rounded-md grid items-center md:hover:scale-95 duration-300 justify-center p-2 ring-1 ring-black/10">
                                    <Image
                                        ...
                                        loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/logos/cocacola.webp"
                                        alt="cocacola"
                                        title="cocacola"
                                    />
                                </div>
                                <div className="rounded-md grid items-center md:hover:scale-95 duration-300 justify-center p-2 ring-1 ring-black/10">
                                    <Image
                                        ...
                                        loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/logos/colgate.webp"
                                        alt="colgate"
                                        title="colgate"
                                    />
                                </div>
                                <div className="rounded-md grid items-center md:hover:scale-95 duration-300 justify-center p-2 ring-1 ring-black/10">
                                    <Image
                                        ...
                                        loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/logos/fabindia.webp"
                                        alt="fabindia"
                                        title="fabindia"
                                    />
                                </div>
                                <div className="rounded-md grid items-center md:hover:scale-95 duration-300 justify-center p-2 ring-1 ring-black/10">
                                    <Image
                                        ...
                                        loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/logos/godrej.webp"
                                        alt="godrej"
                                        title="godrej"
                                    />
                                </div>
                                <div className="rounded-md grid items-center md:hover:scale-95 duration-300 justify-center p-2 ring-1 ring-black/10">
                                    <Image
                                        ...
                                        loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/logos/hdfc.webp"
                                        alt="hdfc"
                                        title="hdfc"
                                    />
                                </div>
                                <div className="rounded-md grid items-center md:hover:scale-95 duration-300 justify-center p-2 ring-1 ring-black/10">
                                    <Image
                                        ...
                                        loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/logos/hero.webp"
                                        alt="hero"
                                        title="hero"
                                    />
                                </div>
                                <div className="rounded-md grid items-center md:hover:scale-95 duration-300 justify-center p-2 ring-1 ring-black/10">
                                    <Image
                                        ...
                                        loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/logos/marutisuzuki.webp"
                                        alt="marutisuzuki"
                                        title="marutisuzuki"
                                    />
                                </div>
                                <div className="rounded-md grid items-center md:hover:scale-95 duration-300 justify-center p-2 ring-1 ring-black/10">
                                    <Image
                                        ...
                                        loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/logos/mcdonalds.webp"
                                        alt="mcdonalds"
                                        title="mcdonalds"
                                    />
                                </div>
                                <div className="rounded-md grid items-center md:hover:scale-95 duration-300 justify-center p-2 ring-1 ring-black/10">
                                    <Image
                                        ...
                                        loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/logos/medanta.webp"
                                        alt="medanta"
                                        title="medanta"
                                    />
                                </div>
                                <div className="rounded-md grid items-center md:hover:scale-95 duration-300 justify-center p-2 ring-1 ring-black/10">
                                    <Image
                                        ...
                                        loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/logos/myfav11.webp"
                                        alt="myfav11"
                                        title="myfav11"
                                    />
                                </div>
                                <div className="rounded-md grid items-center md:hover:scale-95 duration-300 justify-center p-2 ring-1 ring-black/10">
                                    <Image
                                        ...
                                        loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/logos/pepsico.webp"
                                        alt="pepsico"
                                        title="pepsico"
                                    />
                                </div>
                                <div className="rounded-md grid items-center md:hover:scale-95 duration-300 justify-center p-2 ring-1 ring-black/10">
                                    <Image
                                        ...
                                        loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/logos/samsung.webp"
                                        alt="samsung"
                                        title="samsung"
                                    />
                                </div>
                                <div className="rounded-md grid items-center md:hover:scale-95 duration-300 justify-center p-2 ring-1 ring-black/10">
                                    <Image
                                        ...
                                        loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/logos/shaadi.webp"
                                        alt="shaadi"
                                        title="shaadi"
                                    />
                                </div>
                            ...
                            <ul className="xl:w-4/12 lg:w-5/12 md:6/12 sm:w-1/2 w-full grid grid-cols-2 lg:gap-x-12 md:gap-x-9 gap-x-7 lg:gap-y-24 md:gap-y-20 gap-y-16 lg:even:*:translate-y-14 even:*:translate-y-8">
                                <li className="w-full bg-[#2D86FF]/20 md:rounded-2xl rounded-xl md:pb-6 pb-4 md:pt-12 pt-8 md:px-5 px-4 flex flex-col aspect-square justify-center relative">
                                    <div className="lg:w-12 md:w-10 w-7 inline-flex items-center justify-center shrink-0 rounded-md bg-gradient-to-b from-[#2D84FD] to-[#3781FF] lg:py-8 md:py-5 py-4 mx-auto -translate-y-1/2 absolute inset-x-0 top-0">
                                        <Svg name="arrowUpward" className="md:size-8 size-5 relative z-10 text-white" />
                                    </div>
                                ...
                                <li className="w-full bg-[#FF6B39]/20 md:rounded-2xl rounded-xl md:pb-6 pb-4 md:pt-12 pt-8 md:px-5 px-4 flex flex-col aspect-square justify-center relative">
                                    <div className="lg:w-12 md:w-10 w-7 inline-flex items-center justify-center shrink-0 rounded-md bg-gradient-to-b from-[#FF6B39] to-[#F36E0F] lg:py-8 md:py-5 py-4 mx-auto -translate-y-1/2 absolute inset-x-0 top-0">
                                        <Svg name="arrowUpward" className="md:size-8 size-5 relative z-10 text-white rotate-180" />
                                    </div>
                    ...
                    <div className="flex flex-col w-full">
                        ...
                        <div className="flex flex-wrap gap-y-14 -mx-2.5 items-stretch">
                            <div className="md:w-1/3 sm:w-1/2 w-full px-2.5">
                                <div className="w-full flex flex-col relative rounded-lg p-6 pt-12 gap-2.5 bg-gradient-to-b from-[#292929] to-[#131514] h-full">
                                    <div className="size-16 absolute top-0 rounded-full bg-[#FAAD13] shrink-0 flex flex-col items-center justify-center -translate-y-1/2">
                                        <Svg name="carpooling" className="md:size-7 size-6 text-[#1C1B1F]" />
                                    </div>
                                    ...
                                    <label htmlFor="leadPopup" className="inline-flex items-center gap-1 text-xs font-semibold text-[#FAAD13]">
                                        <span>FREE DEMO</span>
                                        <Svg name="arrowForward" className="size-5 text-[#FAAD13]" />
                                    </label>
                                </div>
                            </div>
                            <div className="md:w-1/3 sm:w-1/2 w-full px-2.5">
                                <div className="w-full flex flex-col relative rounded-lg p-6 pt-12 gap-2.5 bg-gradient-to-b from-[#292929] to-[#131514] h-full">
                                    <div className="size-16 absolute top-0 rounded-full bg-[#FAAD13] shrink-0 flex flex-col items-center justify-center -translate-y-1/2">
                                        <Svg name="carRental" className="md:size-7 size-6 text-[#1C1B1F]" />
                                    </div>
                            ...
                            <div className="md:w-1/3 sm:w-1/2 w-full px-2.5">
                                <div className="w-full flex flex-col relative rounded-lg p-6 pt-12 gap-2.5 bg-gradient-to-b from-[#292929] to-[#131514] h-full">
                                    <div className="size-16 absolute top-0 rounded-full bg-[#FAAD13] shrink-0 flex flex-col items-center justify-center -translate-y-1/2">
                                        <Svg name="webDevelopment" className="md:size-7 size-6 text-[#1C1B1F]" />
                                    </div>
                            ...
                            <div className="md:w-1/3 sm:w-1/2 w-full px-2.5">
                                <div className="w-full flex flex-col relative rounded-lg p-6 pt-12 gap-2.5 bg-gradient-to-b from-[#292929] to-[#131514] h-full">
                                    <div className="size-16 absolute top-0 rounded-full bg-[#FAAD13] shrink-0 flex flex-col items-center justify-center -translate-y-1/2">
                                        <Svg name="fleetManagement" className="md:size-7 size-6 text-[#1C1B1F]" />
                                    </div>
                            ...
                            <div className="md:w-1/3 sm:w-1/2 w-full px-2.5">
                                <div className="w-full flex flex-col relative rounded-lg p-6 pt-12 gap-2.5 bg-gradient-to-b from-[#292929] to-[#131514] h-full">
                                    <div className="size-16 absolute top-0 rounded-full bg-[#FAAD13] shrink-0 flex flex-col items-center justify-center -translate-y-1/2">
                                        <Svg name="electricViehcle" className="md:size-7 size-6 text-[#1C1B1F]" />
                                    </div>
                            ...
                            <div className="md:w-1/3 sm:w-1/2 w-full px-2.5">
                                <div className="w-full flex flex-col relative rounded-lg p-6 pt-12 gap-2.5 bg-gradient-to-b from-[#292929] to-[#131514] h-full">
                                    <div className="size-16 absolute top-0 rounded-full bg-[#FAAD13] shrink-0 flex flex-col items-center justify-center -translate-y-1/2">
                                        <Svg name="premium" className="md:size-7 size-6 text-[#1C1B1F]" />
                                    </div>
                    ...
                    <div className="flex flex-col w-full">
                        ...
                        <div className="w-full items-start has-[#panel1:checked]:flex hidden">
                                ...
                                >
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="userPanel1" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiUserFriendlyInterface.webp" alt="User-Friendly Interface" title="User-Friendly Interface" className="max-w-64 w-full mx-auto md:hidden aspect-[375/527]" width="375" height="527" />
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="userPanel2" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiUserRealTimeTracking.webp" alt="Real-Time Tracking" title="Real-Time Tracking" className="max-w-64 w-full mx-auto md:hidden aspect-[375/527]" width="375" height="527" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-[#5B5B5B]">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="userPanel3" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiUserPaymentOption.webp" alt="Payment Options" title="Payment Options" className="max-w-64 w-full mx-auto md:hidden aspect-[375/527]" width="375" height="527" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-[#5B5B5B]">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="userPanel4" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiEmergencySOS.webp" alt="Emergency SOS" title="Emergency SOS" className="max-w-64 w-full mx-auto md:hidden aspect-[375/527]" width="375" height="527" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-[#5B5B5B]">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="userPanel5" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiUserFeedback.webp" alt="Rating and Feedback" title="Rating and Feedback" className="max-w-64 w-full mx-auto md:hidden aspect-[375/527]" width="375" height="527" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-[#5B5B5B]">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="userPanel6" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiSchedulingRide.webp" alt="Scheduling Rides" title="Scheduling Rides" className="max-w-64 w-full mx-auto md:hidden aspect-[375/527]" width="375" height="527" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-[#5B5B5B]">Swipe to show features</div>
                                            </div>
                            ...
                            <div className="xl:w-4/12 md:w-1/2 pl-20 md:!pt-12 !pt-7 !pb-6 md:sticky md:top-16 md:bottom-0 md:h-dvh max-md:hidden flex flex-col justify-center">
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiUserFriendlyInterface.webp" alt="User-Friendly Interface" title="User-Friendly Interface" width="375" height="527" className="w-full mx-auto xl:max-w-96 max-w-64 aspect-[375/527] hidden group-has-[#userPanel1:checked]/key:md:block" />
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiUserRealTimeTracking.webp" alt="Real-Time Tracking" title="Real-Time Tracking" width="375" height="527" className="w-full mx-auto xl:max-w-96 max-w-64 aspect-[375/527] hidden group-has-[#userPanel2:checked]/key:md:block" />
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiUserPaymentOption.webp" alt="Payment Options" title="Payment Options" width="375" height="527" className="w-full mx-auto xl:max-w-96 max-w-64 aspect-[375/527] hidden group-has-[#userPanel3:checked]/key:md:block" />
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiEmergencySOS.webp" alt="Emergency SOS" title="Emergency SOS" width="375" height="527" className="w-full mx-auto xl:max-w-96 max-w-64 aspect-[375/527] hidden group-has-[#userPanel4:checked]/key:md:block" />
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiUserFeedback.webp" alt="Rating and Feedback" title="Rating and Feedback" width="375" height="527" className="w-full mx-auto xl:max-w-96 max-w-64 aspect-[375/527] hidden group-has-[#userPanel5:checked]/key:md:block" />
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiSchedulingRide.webp" alt="Scheduling Rides" title="Scheduling Rides" width="375" height="527" className="w-full mx-auto xl:max-w-96 max-w-64 aspect-[375/527] hidden group-has-[#userPanel6:checked]/key:md:block" />
                            </div>
                        </div>
                        <div className="w-full items-start has-[#panel2:checked]:flex hidden">
                                ...
                                >
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="servicePanel1" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/texiDriverRideAssignment.webp" alt="Dynamic Ride Assignments" title="Dynamic Ride Assignments" className="max-w-64 w-full mx-auto md:hidden aspect-[375/527]" width="375" height="527" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-[#5B5B5B]">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="servicePanel2" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiDriverNavigation.webp" alt="Navigation Integration" title="Navigation Integration" className="max-w-64 w-full mx-auto md:hidden aspect-[375/527]" width="375" height="527" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-[#5B5B5B]">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="servicePanel3" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/texiDriverEarningDashboard.webp" alt="Earnings Dashboard" title="Earnings Dashboard" className="max-w-64 w-full mx-auto md:hidden aspect-[375/527]" width="375" height="527" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-[#5B5B5B]">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="servicePanel4" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiDriverProfileManagement.webp" alt="Profile Management" title="Profile Management" className="max-w-64 w-full mx-auto md:hidden aspect-[375/527]" width="375" height="527" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-[#5B5B5B]">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="servicePanel5" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiDriverStatusUpdate.webp" alt="Status Updates" title="Status Updates" className="max-w-64 w-full mx-auto md:hidden aspect-[375/527]" width="375" height="527" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-[#5B5B5B]">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="servicePanel6" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiDriverFeedback.webp" alt="Customer Feedback" title="Customer Feedback" className="max-w-64 w-full mx-auto md:hidden aspect-[375/527]" width="375" height="527" />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-[#5B5B5B]">Swipe to show features</div>
                                            </div>
                            ...
                            <div className="xl:w-4/12 md:w-1/2 pl-20 md:!pt-12 !pt-7 !pb-6 md:sticky md:top-16 md:bottom-0 md:h-dvh max-md:hidden flex flex-col justify-center">
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/texiDriverRideAssignment.webp" alt="Dynamic Ride Assignments" title="Dynamic Ride Assignments" width="375" height="527" className="w-full mx-auto xl:max-w-96 max-w-64 aspect-[375/527] hidden group-has-[#servicePanel1:checked]/key:md:block" />
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiDriverNavigation.webp" alt="Navigation Integration" title="Navigation Integration" width="375" height="527" className="w-full mx-auto xl:max-w-96 max-w-64 aspect-[375/527] hidden group-has-[#servicePanel2:checked]/key:md:block" />
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/texiDriverEarningDashboard.webp" alt="Earnings Dashboard" title="Earnings Dashboard" width="375" height="527" className="w-full mx-auto xl:max-w-96 max-w-64 aspect-[375/527] hidden group-has-[#servicePanel3:checked]/key:md:block" />
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiDriverProfileManagement.webp" alt="Profile Management" title="Profile Management" width="375" height="527" className="w-full mx-auto xl:max-w-96 max-w-64 aspect-[375/527] hidden group-has-[#servicePanel4:checked]/key:md:block" />
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiDriverStatusUpdate.webp" alt="Status Updates" title="Status Updates" width="375" height="527" className="w-full mx-auto xl:max-w-96 max-w-64 aspect-[375/527] hidden group-has-[#servicePanel5:checked]/key:md:block" />
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiDriverFeedback.webp" alt="Customer Feedback" title="Customer Feedback" width="375" height="527" className="w-full mx-auto xl:max-w-96 max-w-64 aspect-[375/527] hidden group-has-[#servicePanel6:checked]/key:md:block" />
                            </div>
                        </div>
                        <div className="w-full items-start has-[#panel3:checked]:flex hidden">
                                ...
                                >
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="adminPanel1" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiAdmin.webp" alt="Dashboard and Analytics" title="Dashboard and Analytics" className="max-w-64 w-full mx-auto md:hidden aspect-[256/179]" width={256} height={179} />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-[#5B5B5B]">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="adminPanel2" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiAdmin.webp" alt="User and Driver Management" title="User and Driver Management" className="max-w-64 w-full mx-auto md:hidden aspect-[256/179]" width={256} height={179} />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-[#5B5B5B]">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="adminPanel3" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiAdmin.webp" alt="Fare and Pricing Control" title="Fare and Pricing Control" className="max-w-64 w-full mx-auto md:hidden aspect-[256/179]" width={256} height={179} />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-[#5B5B5B]">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="adminPanel4" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiAdmin.webp" alt="Geofencing and Location Control" title="Geofencing and Location Control" className="max-w-64 w-full mx-auto md:hidden aspect-[256/179]" width={256} height={179} />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-[#5B5B5B]">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="adminPanel5" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiAdmin.webp" alt="Customer Support" title="Customer Support" className="max-w-64 w-full mx-auto md:hidden aspect-[256/179]" width={256} height={179} />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-[#5B5B5B]">Swipe to show features</div>
                                            </div>
                                    ...
                                    <SwiperSlide className="swiper-slide group md:!w-full max-md:!h-auto max-md:!flex max-md:!flex-col">
                                        <label htmlFor="adminPanel6" className="md:!w-full cursor-pointer h-full max-md:!flex max-md:!flex-col">
                                            ...
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiAdmin.webp" alt="Security and Compliance" title="Security and Compliance" className="max-w-64 w-full mx-auto md:hidden aspect-[256/179]" width={256} height={179} />
                                            <div className="flex gap-2.5 items-center justify-center pt-4 md:hidden">
                                                <Svg name="swiper" className="size-6 shrink-0 text-[#5B5B5B]" />
                                                <div className="md:text-xs text-[10px] font-normal text-[#5B5B5B]">Swipe to show features</div>
                                            </div>
                            ...
                            <div className="xl:w-4/12 md:w-1/2 pl-20 md:!pt-12 !pt-7 !pb-6 md:sticky md:top-16 md:bottom-0 md:h-dvh max-md:hidden flex flex-col justify-center">
                                <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiAdmin.webp" alt="admin" title="admin" className="w-full mx-auto xl:max-w-96 max-w-64 aspect-[375/263] max-md:hidden" width={375} height={263} />
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <SwiperSlide className="swiper-slide !flex flex-wrap justify-between items-stretch bg-[#1D1D1D] rounded-3xl xl:p-12 md:p-8 py-6 px-4 gap-y-6">
                                    <div className="md:w-7/12 w-full">
                                        <div className="w-full flex items-center xl:gap-8 md:gap-4 gap-2">
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/boltzyLogo.webp" width="56" height="56" className="w-auto md:h-14 h-12 aspect-square" alt="Boltzy Logo" title="Boltzy Logo" />
                                        ...
                                        <div className="flex items-center lg:gap-3 gap-2 md:pt-6 pt-3">
                                            ...
                                            <div className="w-auto inlne-flex flex-col gap-0.5 text-center">
                                                <Image loading="lazy" decoding="async" src="https://d1y41eupgbwbb2.cloudfront.net/images/playStoreBtnBlack.webp" className="w-auto xl:h-10 h-8 aspect-[120/40]" width="120" height="40" alt="PlayStore" title="PlayStore" />
                                            </div>
                                            <div className="w-auto inlne-flex flex-col gap-0.5 text-center">
                                                <Image loading="lazy" decoding="async" src="https://d1y41eupgbwbb2.cloudfront.net/images/appStoreBtnBlack.webp" className="w-auto xl:h-10 h-8 aspect-[120/40]" width="120" height="40" alt="AppStore" title="AppStore" />
                                            </div>
                                        </div>
                                        <div className="w-full md:pt-8 pt-6">
                                            <label htmlFor="leadPopup" className="cursor-pointer xl:text-base sm:text-sm text-xs md:font-semibold font-medium text-white inline-flex items-center xl:py-3 sm:py-2.5 py-2 xl:ps-6 sm:ps-4 ps-3 xl:pe-3 sm:pe-2.5 pe-1.5 xl:gap-3 gap-2 rounded-full bg-gradient-to-b from-[#3280FF] to-[#3876C0] duration-500 hover:lg:ring-4 hover:lg:ring-inset hover:lg:ring-[#3876C0] group/btn">
                                                ...
                                                <div className="inline-flex items-center justify-center shrink-0 xl:size-7 size-6 rounded-full bg-white group-hover/btn:lg:scale-110 relative group-hover/btn:lg:bg-[#3280FF] before:absolute before:inset-0 before:rounded-full before:bg-white before:duration-300 before:scale-0 group-hover/btn:lg:before:scale-100 duration-300">
                                                    <Svg name="arrowCall" className="size-3 relative z-10 text-[#3876C0]" />
                                                </div>
                                            </label>
                                        </div>
                                    </div>
                                    <div className="md:w-4/12 w-full max-md:order-first rounded-3xl aspect-square flex items-center justify-center bg-gradient-to-br from-[#3280FF] to-[#3876C0] p-6">
                                        <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/boltzy.webp" alt="Boltzy" title="Boltzy" className="size-full object-contain object-center aspect-square" width={375} height={375} />
                                    </div>
                                </SwiperSlide>
                                <SwiperSlide className="swiper-slide !flex flex-wrap justify-between items-stretch bg-[#1D1D1D] rounded-3xl xl:p-12 md:p-8 py-6 px-4 gap-y-6">
                                    <div className="md:w-7/12 w-full">
                                        <div className="w-full flex items-center xl:gap-8 md:gap-4 gap-2">
                                            <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/cabbitLogo.webp" width="56" height="56" className="w-auto md:h-14 h-12 aspect-square" alt="Cabbit Logo" title="Cabbit Logo" />
                                        ...
                                        <div className="w-full md:pt-8 pt-6">
                                            <label htmlFor="leadPopup" className="cursor-pointer xl:text-base sm:text-sm text-xs md:font-semibold font-medium text-white inline-flex items-center xl:py-3 sm:py-2.5 py-2 xl:ps-6 sm:ps-4 ps-3 xl:pe-3 sm:pe-2.5 pe-1.5 xl:gap-3 gap-2 rounded-full bg-gradient-to-b from-[#FDC91E] to-[#FF8801] duration-500 hover:lg:ring-4 hover:lg:ring-inset hover:lg:ring-[#FF8801] group/btn">
                                                ...
                                                <div className="inline-flex items-center justify-center shrink-0 xl:size-7 size-6 rounded-full bg-white group-hover/btn:lg:scale-110 relative group-hover/btn:lg:bg-[#FDC91E] before:absolute before:inset-0 before:rounded-full before:bg-white before:duration-300 before:scale-0 group-hover/btn:lg:before:scale-100 duration-300">
                                                    <Svg name="arrowCall" className="size-3 relative z-10 text-[#FF8801]" />
                                                </div>
                                            </label>
                                        </div>
                                    </div>
                                    <div className="md:w-4/12 w-full max-md:order-first rounded-3xl aspect-square flex items-center justify-center bg-gradient-to-br from-[#FDC91E] to-[#FF8801] p-6">
                                        <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/cabbit.webp" alt="Cabbit" title="Cabbit" className="size-full object-contain object-center aspect-square" width={375} height={375} />
                                    </div>
                                </SwiperSlide>
                    ...
                    <div className="flex flex-col w-full">
                        ...
                        <div className="flex flex-wrap xl:-mx-5 -mx-3 xl:gap-y-10 gap-y-6">
                            <div className="md:w-1/2 w-full xl:px-5 px-3">
                                <div className="w-full flex flex-col gap-6 bg-gradient-to-b from-[#FFF7EB] via-[#FFF8EE] to-[#FFFFFF] rounded-2xl lg:p-16 md:p-10 p-8 h-full">
                                    <div className="w-full">
                                        <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/carpoolingAndRentalIcon.webp" alt="Carpooling And Rental" title="Carpooling And Rental" width="288" height="192" className="w-auto xl:h-48 md:h-36 h-24 object-contain object-center mx-auto aspect-[288/192]" />
                                    </div>
                            ...
                            <div className="md:w-1/2 w-full xl:px-5 px-3">
                                <div className="w-full flex flex-col gap-6 bg-gradient-to-b from-[#FFF7EB] via-[#FFF8EE] to-[#FFFFFF] rounded-2xl lg:p-16 md:p-10 p-8 h-full">
                                    <div className="w-full">
                                        <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/privateTaxiBusinessIcon.webp" alt="Private Taxi Business" title="Private Taxi Business" width="288" height="192" className="w-auto xl:h-48 md:h-36 h-24 object-contain object-center mx-auto aspect-[288/192]" />
                                    </div>
                                    <div className="w-full flex flex-col gap-4">
                            ...
                            <div className="md:w-1/2 w-full xl:px-5 px-3">
                                <div className="w-full flex flex-col gap-6 bg-gradient-to-b from-[#FFF7EB] via-[#FFF8EE] to-[#FFFFFF] rounded-2xl lg:p-16 md:p-10 p-8 h-full">
                                    <div className="w-full">
                                        <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/corporateTaxiBusinessIcon.webp" alt="Corporate Taxi Business" title="Corporate Taxi Business" width="288" height="192" className="w-auto xl:h-48 md:h-36 h-24 object-contain object-center mx-auto aspect-[288/192]" />
                                    </div>
                                    <div className="w-full flex flex-col gap-4">
                            ...
                            <div className="md:w-1/2 w-full xl:px-5 px-3">
                                <div className="w-full flex flex-col gap-6 bg-gradient-to-b from-[#FFF7EB] via-[#FFF8EE] to-[#FFFFFF] rounded-2xl lg:p-16 md:p-10 p-8 h-full">
                                    <div className="w-full">
                                        <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/deliveryLogisticsAppsIcon.webp" alt="Delivery & Logistics Apps" title="Delivery & Logistics Apps" width="288" height="192" className="w-auto xl:h-48 md:h-36 h-24 object-contain object-center mx-auto aspect-[288/192]" />
                                    </div>
                                    <div className="w-full flex flex-col gap-4">
                    ...
                    <div className="flex flex-col w-full">
                        <div className="flex flex-wrap justify-between relative items-start">
                            <div className="lg:w-5/12 md:w-5/12 w-full md:sticky md:top-32">
                                ...
                                <div className="w-full">
                                    <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiInnovativeTechnologies.webp" alt="Innovative Technologies For Advanced Taxi Booking App Development" title="Innovative Technologies For Advanced Taxi Booking App Development" width="569" height="378" className="w-full aspect-[569/378]" />
                                </div>
                            </div>
            ...
            <section className="cta1Section w-full relative overflow-hidden bg-[#050505] flex flex-col">
                                ...
                                <div className="w-full md:pt-6 pt-4 max-md:text-center">
                                    <label htmlFor="leadPopup" className="cursor-pointer xl:text-base sm:text-sm text-xs md:font-semibold font-medium text-white inline-flex items-center xl:py-3 sm:py-2.5 py-2 xl:ps-6 sm:ps-4 ps-3 xl:pe-3 sm:pe-2.5 pe-1.5 xl:gap-3 gap-2 rounded-full bg-gradient-to-b from-[#4E93FF] to-[#1C67FF] duration-500 hover:lg:ring-4 hover:lg:ring-inset hover:lg:ring-[#1C67FF] group/btn">
                                        ...
                                        <div className="inline-flex items-center justify-center shrink-0 xl:size-7 size-6 rounded-full bg-white group-hover/btn:lg:scale-110 relative group-hover/btn:lg:bg-[#4E93FF] before:absolute before:inset-0 before:rounded-full before:bg-white before:duration-300 before:scale-0 group-hover/btn:lg:before:scale-100 duration-300">
                                            <Svg name="arrowCall" className="size-3 relative z-10 text-[#1C67FF]" />
                                        </div>
                                    </label>
                                </div>
                            </div>
                ...
                <div className="lg:w-6/12 md:w-7/12 w-full rounded-3xl flex items-center justify-center md:absolute relative right-0 inset-y-0 max-md:order-first max-md:aspect-video max-sm:aspect-[16/12]">
                    <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/carMaps.webp" alt="Kickstart your Online Taxi Booking Business Today!" title="Kickstart your Online Taxi Booking Business Today!" width="763" height="422" className="size-full object-cover object-right aspect-[763/422]" />
                </div>
            </section>
                        ...
                        <Swiper className="swiper flex xl:w-7/12 lg:w-3/4 w-full -mt-6 xl:!py-16 lg:!py-14 !py-12 before:absolute before:left-0 before:h-full before:w-1/4 before:bg-gradient-to-r before:from-[#131514]/60 before:to-transparent before:z-10 before:pointer-events-none after:absolute after:right-0 after:h-full after:w-1/4 after:bg-gradient-to-l after:from-[#131514]/60 after:to-transparent after:z-10 after:pointer-events-none"
                            ...
                            >
                                <SwiperSlide className="swiper-slide relative lg:p-[1.2%] md:p-[2.2%] p-[2.7%] group [&.swiper-slide-active]:!scale-100 md:!scale-95 !scale-90 duration-300">
                                    ...
                                    <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiLookLike1.webp" alt="Taxi App Look like" title="Taxi App Look like" className="size-full object-contain object-center" width="225" height="505" />
                                </SwiperSlide>
                                <SwiperSlide className="swiper-slide relative lg:p-[1.2%] md:p-[2.2%] p-[2.7%] group [&.swiper-slide-active]:!scale-100 md:!scale-95 !scale-90 duration-300">
                                    <Svg name="blackMobileFrame" className="size-full object-contain object-center absolute inset-0 text-[#404040] opacity-0 group-[&.swiper-slide-active]:opacity-100 scale-125 group-[&.swiper-slide-active]:scale-100 duration-300" />
                                    <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiLookLike2.webp" alt="Taxi App Look like" title="Taxi App Look like" className="size-full object-contain object-center" width="225" height="505" />
                                </SwiperSlide>
                                <SwiperSlide className="swiper-slide relative lg:p-[1.2%] md:p-[2.2%] p-[2.7%] group [&.swiper-slide-active]:!scale-100 md:!scale-95 !scale-90 duration-300">
                                    <Svg name="blackMobileFrame" className="size-full object-contain object-center absolute inset-0 text-[#404040] opacity-0 group-[&.swiper-slide-active]:opacity-100 scale-125 group-[&.swiper-slide-active]:scale-100 duration-300" />
                                    <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiLookLike3.webp" alt="Taxi App Look like" title="Taxi App Look like" className="size-full object-contain object-center" width="225" height="505" />
                                </SwiperSlide>
                                <SwiperSlide className="swiper-slide relative lg:p-[1.2%] md:p-[2.2%] p-[2.7%] group [&.swiper-slide-active]:!scale-100 md:!scale-95 !scale-90 duration-300">
                                    <Svg name="blackMobileFrame" className="size-full object-contain object-center absolute inset-0 text-[#404040] opacity-0 group-[&.swiper-slide-active]:opacity-100 scale-125 group-[&.swiper-slide-active]:scale-100 duration-300" />
                                    <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiLookLike4.webp" alt="Taxi App Look like" title="Taxi App Look like" className="size-full object-contain object-center" width="225" height="505" />
                                </SwiperSlide>
                                <SwiperSlide className="swiper-slide relative lg:p-[1.2%] md:p-[2.2%] p-[2.7%] group [&.swiper-slide-active]:!scale-100 md:!scale-95 !scale-90 duration-300">
                                    <Svg name="blackMobileFrame" className="size-full object-contain object-center absolute inset-0 text-[#404040] opacity-0 group-[&.swiper-slide-active]:opacity-100 scale-125 group-[&.swiper-slide-active]:scale-100 duration-300" />
                                    <Image loading="lazy" src="https://d1y41eupgbwbb2.cloudfront.net/images/taxiLookLike5.webp" alt="Taxi App Look like" title="Taxi App Look like" className="size-full object-contain object-center" width="225" height="505" />
                                </SwiperSlide>
                        </Swiper>
                    </div>
                </div>
                ...
                <div className="!container flex xl:py-16 lg:py-14 md:py-12 sm:py-10 py-8">
                    <div className="flex flex-col w-full">
                        ...
                        <div className="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 2xl:gap-9 lg:gap-7 md:gap-5 gap-4 w-full relative z-10">
                            ...
                            <Link href="food-delivery-app-development.php" className="w-full cursor-pointer flex items-center 2xl:rounded-3xl md:rounded-2xl rounded-xl 2xl:p-5 md:p-4 p-3 2xl:gap-5 md:gap-3 gap-2 bg-gradient-to-br from-[#C3C3C0] to-[#000000] relative before:absolute 2xl:before:inset-[2.75px] md:before:inset-[2px] before:inset-[1.38px] hover:lg:before:inset-1.5 before:duration-300 2xl:before:rounded-[22px] md:before:rounded-[14px] before:rounded-[10px] before:bg-[#050505] before:m-auto before:z-0 after:absolute 2xl:after:inset-[2.75px] md:after:inset-[2px] after:inset-[1.38px] hover:lg:after:inset-1.5 after:duration-300 2xl:after:rounded-[22px] md:after:rounded-[14px] after:rounded-[10px] after:bg-gradient-to-b after:from-[#ffffff24] after:via-[#efe2ff12] after:to-[#e9f6fc24] after:m-auto after:z-[1]">
                                <div className="2xl:size-24 md:size-12 size-9 flex relative z-10 items-center justify-center 2xl:rounded-2xl md:rounded-xl rounded-lg shrink-0 bg-gradient-to-b from-[#ffffff24] via-[#efe2ff12] to-[#e9f6fc24]">
                                    <Svg name="burger" className="2xl:size-14 md:size-8 size-5 relative z-10 text-white" />
                                </div>
